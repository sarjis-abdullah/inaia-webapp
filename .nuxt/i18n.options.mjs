...
export const resolveNuxtI18nOptions = async (context) => {
  ...
  "1": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["The first"])};fn.source="The first";return fn;})(),
  ...
  "1": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Le premier"])};fn.source="Le premier";return fn;})(),
