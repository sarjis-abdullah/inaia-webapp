<template>
    ...
    <div  class="grid grid-cols-3 gap-10 mt-10">
        ...
        <div class="">
            ...
            <div class="flex flex-row justify-between items-center rounded-lg bg-white shadow p-3" v-if="depot">
                <NuxtLink :to="'/'+lang+'/trading/buy/'+id" class="flex w-full cursor-pointer mx-1 justify-center rounded-md border border-transparent bg-blue-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">{{ $t('buy') }}</NuxtLink>
                <NuxtLink :to="tradeableAmount==0?'':'/'+lang+'/trading/sell/'+id" :class="['flex w-full cursor-pointer mx-1 justify-center rounded-md border border-transparent bg-blue-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2',tradeableAmount==0?'opacity-50':'opacity-100']">{{ $t('sell') }}</NuxtLink>
