<template>
    <div>
        <h2 class="text-center mb-8 text-2xl font-bold">{{ $t('asset_transfer') }}</h2>
...
import { type Depot,type  TradeableAmount } from '@/lib/models';
import { Ref } from 'vue'
...
const receiverDepot: Ref<Depot> = ref(null);
...
const onReceiverDepotSelected = (depot: Depot)=>{
...
const save = async () => {
    try {
        ...
        emit("save", {
            ...
            receiverDepot: receiverDepot.value,
