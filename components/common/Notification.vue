<template>
    ...
    <div aria-live="assertive" class="pointer-events-none fixed inset-0 flex items-end px-4 py-6 sm:items-start sm:p-6 z-10" :class="className">
            ...
            <div class="p-4">
              <div class="flex items-start">
                <div class="flex-shrink-0">
                  <CheckCircleIcon class="h-6 w-6 text-green-400" aria-hidden="true" v-if="type==types.sucess"/>
                  <XCircleIcon class="h-6 w-6 text-red-400" aria-hidden="true" v-if="type==types.danger"/>
                  <ExclamationCircleIcon class="h-6 w-6 text-yellow-400" aria-hidden="true" v-if="type==types.warning"/>
                </div>
  ...
  const props = defineProps({
    ...
    type:{
        default:NotificationTypes.sucess
    },
    duration:{
        default:5000
    },
