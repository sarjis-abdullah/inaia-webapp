<template>
    ...
    <div class="divide-y divide-gray-200 rounded-lg border border-gray-200 shadow-sm" v-if="plan">
          <div class="p-6">
            ...
            <a  class="mt-8 block w-full rounded-md border border-gray-800 bg-gray-800 py-2 text-center text-sm font-semibold text-white hover:bg-gray-900">Buy {{ plan.name }}</a>
          </div>
