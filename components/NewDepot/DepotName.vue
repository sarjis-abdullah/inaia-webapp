<template>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <SelectAvatar icon-class="top-[12px]" :avatar-url="target?.avatar_base64 ?? target?.avatar" @onSelectAvatar="handleOnSelectAvatar" className="88 h-32 w-32 mx-auto mb-4" />
        </div>
            <div class="mt-10">
