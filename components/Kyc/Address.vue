<template>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10" v-else-if="isVerified">
            ...
            <a class="flex w-full justify-center rounded-md border border-transparent bg-blue-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">{{ $t('goToDashboard') }}</a>
        </div>
