    ...
    <TransitionRoot as="template" :show="sidebarOpen">
      <Dialog as="div" class="relative z-50 lg:hidden" @close="sidebarOpen = false">
            ...
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2">
                <div class="flex h-16 shrink-0 items-center">
                  <img class="h-8 w-auto" src="~/assets/img/logo/logo.png" alt="INAIA GmbH" />
                </div>
        ...
        <li v-for="step in steps" :key="step.name">
                    ...
                    <a v-else-if="step.status === 'current'"  @click.prevent="navigateToStep(step.number)" class="flex items-start" aria-current="step">
              ...
              <nav class="flex justify-center absolute inset-x-0 bottom-2 mb-2">
      <ol role="list" class="space-y-3">
        <li class="text-center text-sm text-stone-800">
          <a >
