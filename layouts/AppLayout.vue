          ...
          <MenuItem v-slot="{ active }">
            ...
            <div class="hidden md:block">
              <div class="ml-4 flex items-center md:ml-6">
                ...
                <button @click="gotoSupport" type="button" class="relative rounded-full bg-blue-700 p-1 text-blue-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-600">
                  <span v-if="newInboxMessageCount" class="absolute top-[-10px] right-[-4px] h-4 w-4 text-[10px] text-blue-700 rounded-full bg-white p-[2px]">
                    {{ newInboxMessageCount }}
                  </span>
                  <span class="sr-only">View Inbox Messages</span>
                  
                  <svg class="h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>headphones</title><path d="M12,1C7,1 3,5 3,10V17A3,3 0 0,0 6,20H9V12H5V10A7,7 0 0,1 12,3A7,7 0 0,1 19,10V12H15V20H18A3,3 0 0,0 21,17V10C21,5 16.97,1 12,1Z" /></svg>
                </button>
